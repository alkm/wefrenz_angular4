(function (global, factory) {
	...
	(factory((global['ngx-image-cropper'] = {}),global.ng.core,global.ng.common));
...
var ImageCropperComponent = (function () {
    ...
    ImageCropperComponent.prototype.move = function (event) {
        var /** @type {?} */ diffX = (event.clientX - this.moveStart.clientX);
        var /** @type {?} */ diffY = (event.clientY - this.moveStart.clientY);
    ...
    ImageCropperComponent.prototype.crop = function () {
        ...
        if (displayedImage) {
            ...
            var /** @type {?} */ resizeRatio = this.resizeToWidth > 0 ? this.resizeToWidth / width : 1;
